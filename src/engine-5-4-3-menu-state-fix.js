...
function isQuestChild(){const h=title();const t=text();return !isQuestMain()&&(h.includes('미션')||h.includes('Mission')||h.includes('업적')||h.includes('칭호')||t.includes('일일미션')||t.includes('메인 미션')||t.includes('누적 플레이 업적'))}

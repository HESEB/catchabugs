...
const OLD_BUTTON_IDS = ['openDex','openDexReward','openQuest','openAchievement','openBadgeTitle','openSave','openWeather','openLab','openLegendary','diary','home'];
const HUB_MENUS = [
...
const RETURN_POINTS = [
  { id: 'lab', icon: '🏠', name: '연구소', desc: '연구 업그레이드와 장비 개선을 진행합니다.', type: 'lab', defaultOpen: true },
...
function loadSettings() { return safeParse(localStorage.getItem(MENU_SETTINGS_KEY)) || { sound: true, vibration: true, returnAllOpen: false, infiniteMoney: false }; }

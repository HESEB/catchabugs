...
const ACHIEVEMENTS = Object.freeze([
  ...
  { id: 'dex-30-achievement', icon: '📗', title: '도감 30%', desc: '서로 다른 곤충 3종을 기록한다.', type: 'uniqueSpecies', target: 3, reward: 160 },
  { id: 'dex-50-achievement', icon: '📙', title: '도감 50%', desc: '서로 다른 곤충 5종을 기록한다.', type: 'uniqueSpecies', target: 5, reward: 260 },
  { id: 'dex-complete-achievement', icon: '📚', title: '도감 완성가', desc: '현재 등록된 모든 곤충을 기록한다.', type: 'uniqueSpecies', target: 10, reward: 700 },
